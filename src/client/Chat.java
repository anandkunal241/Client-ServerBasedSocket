...
public class Chat extends javax.swing.JFrame {
    ...
    private Message inmsg,outmsg;
    private ArrayList<Byte>list;
    private Messagetype messagetype;
    private static String fileprefix="/home/kunal/Inventory/";
    ...
    public Chat(Socket socket) throws IOException {
        System.out.println("In Chat page");
        this.socket = socket;
        outmsg = new Message();
    ...
    private class helperthread implements Runnable
    {
        ...
        {
            String filepath = Chat.fileprefix + inmsg.getFilename();
